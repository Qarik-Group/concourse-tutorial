...
- name: job-pass-files
  ...
  - task: create-some-files
    file: resource-tutorial/11-task-outputs-to-inputs/create_some_files.yml
  - task: show-some-files
    file: resource-tutorial/11-task-outputs-to-inputs/show_files.yml
```
